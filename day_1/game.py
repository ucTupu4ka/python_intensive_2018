...
class Missile:
    ...
    def __init__(self, x, y, color, x2, y2, name):
        self.color = color
        self.name = name
...
def fire_missile(x, y):
    info = Missile(color='white', x=BASE_X, y=BASE_Y + 30, x2=x, y2=y, name='missile')
...
def fire_enemy_missile():
    ...
    if alive_buildings:
        ...
        info = Missile(color='red', x=x, y=y, x2=target.x, y2=target.y, name='missile')
